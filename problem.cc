 ...
 do
  {
   ...
   // direct Newton update
    ...
    {
     double factor = 0.5;
     std::cout << "Direct Newton Update has been multiplied by " << factor << std::endl;
     for (unsigned l = 0; l < ndof_local; l++)
      {
       *Dof_pt[l] -= factor*dx_pt[l];
       //previously was
       //*Dof_pt[l] -= dx_pt[l];
      }
    }
                          ...
                          DoubleVector &z)
{
 ...
 do
   ...
   *parameter_pt -= dparam;
   ...
   //Damping the newton step
   double dampFactor = 0.5;
   std::cout << "Damping Newton step by factor " << dampFactor << std::endl;

   //Update the values of the other degrees of freedom
   for(unsigned long l=0;l<ndof_local;l++)
    {
     *Dof_pt[l] -= dampFactor * (y_pt[l] - dparam*z_pt[l]);
    }
