...
/*
// OOMPH-LIB headers when in src directory
...
#include "axisym_solid_elements.cc"
...
/// direction.
/// NB. the deformed radius is x[0] and the deformed angle from the vertical
/// is x[1] + xi[1]
//=====================================================================
...
public virtual SolidFiniteElement
{
 ...
 virtual void solid_pshape(const Vector<double> &s, Shape &psi) const=0;
  ...
  //Inserted by Edgar from solid_elements -- not needed, causes error?
